...
def inception_res_A(tf, x,base_name,training=True):
  ...
  x_image=x
  W_A_conv1 = deep_dive.weight_variable_scaling([1,1,32,12], name='W_A_conv1'+base_name)
  ...
  W_A_conv2 = deep_dive.weight_variable_scaling([1,1,32,12], name='W_A_conv2'+base_name)
  ...
  W_A_conv3 = deep_dive.weight_variable_scaling([3,3,12,12], name='W_A_conv3'+base_name)
  ...
  W_A_conv4 = deep_dive.weight_variable_scaling([1,1,32,16], name='W_A_conv4'+base_name)
  ...
  W_A_conv5 = deep_dive.weight_variable_scaling([3,3,16,24], name='W_A_conv5'+base_name)
  ...
  W_A_conv6 = deep_dive.weight_variable_scaling([3,3,24,32], name='W_A_conv6'+base_name)
  ...
  W_A_conv7 = deep_dive.weight_variable_scaling([1,1,56,32], name='W_A_conv7'+base_name)
