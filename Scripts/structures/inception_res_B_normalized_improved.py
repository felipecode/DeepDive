...
def inception_res_B(tf, x,base_name,training=True):
  ...
  W_B_conv1 = deep_dive.weight_variable_scaling([1,1,32,48], name='W_B_conv1'+base_name)
  ...
  W_B_conv2 = deep_dive.weight_variable_scaling([1,1,32,48], name='W_B_conv2'+base_name)
  ...
  W_B_conv3 = deep_dive.weight_variable_scaling([1,3,48,56], name='W_B_conv3'+base_name)
  ...
  W_B_conv4 = deep_dive.weight_variable_scaling([3,1,56,64], name='W_B_conv4'+base_name)
  ...
  W_B_conv5 = deep_dive.weight_variable_scaling([1,1,112,32], name='W_B_conv5'+base_name)
