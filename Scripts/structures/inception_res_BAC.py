...
def create_structure(tf, x, input_size,dropout):
  ...
  W_B_conv1 = deep_dive.weight_variable_scaling([1,1,3,24], name='W_B_conv1')
  b_B_conv1 = deep_dive.bias_variable([24])
  B_conv1 = deep_dive.conv2d(x_image, W_B_conv1,strides=[1, 1, 1, 1], padding='SAME') + b_B_conv1
  print B_conv1
  ...
  W_B_conv2 = deep_dive.weight_variable_scaling([1,1,3,24], name='W_B_conv2')
  b_B_conv2 = deep_dive.bias_variable([24])
  B_conv2 = deep_dive.conv2d(x_image, W_B_conv1,strides=[1, 1, 1, 1], padding='SAME') + b_B_conv2
  print B_conv2
