...
"""
from inception_res_A_normalized_improved import *

from inception_res_B_normalized_improved import *

from inception_res_C_normalized_improved import *
def create_structure(tf, x, input_size,dropout,training=True):
  ...
  W_conv1 = deep_dive.weight_variable_scaling([7,7,3,32],name='W_conv1')
  ...
  W_conv2 = deep_dive.weight_variable_scaling([7,7,32,3],name='W_conv2')
