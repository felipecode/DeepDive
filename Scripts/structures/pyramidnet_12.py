...
def create_structure(tf, x, input_size,dropout,training=True):
  ...
  last_layer1,features1,histograms1=layer_pyramid(tf=tf, x=conv1,training=training,base_name="layer1")
  features.update(features1)
  histograms.update(histograms1)

  last_layer2,features2,histograms2=layer_pyramid(tf=tf, x=last_layer1,training=training,base_name="layer2")
  features.update(features2)
  histograms.update(histograms2)

  last_layer3,features3,histograms3=layer_pyramid(tf=tf, x=last_layer2,training=training,base_name="layer3")
  features.update(features3)
  histograms.update(histograms3)

  last_layer4,features4,histograms4=layer_pyramid(tf=tf, x=last_layer3,training=training,base_name="layer4")
  features.update(features4)
  histograms.update(histograms4)
  '''
  last_layer5,features5,histograms5=layer_pyramid(tf=tf, x=last_layer4,training=training,base_name="layer5")
  features.update(features5)
  histograms.update(histograms5)

  last_layer6,features6,histograms6=layer_pyramid(tf=tf, x=last_layer5,training=training,base_name="layer6")
  features.update(features6)
  histograms.update(histograms6)

  last_layer7,features7,histograms7=layer_pyramid(tf=tf, x=last_layer6,training=training,base_name="layer7")
  features.update(features7)
  histograms.update(histograms7)

  last_layer8,features8,histograms8=layer_pyramid(tf=tf, x=last_layer7,training=training,base_name="layer8")
  features.update(features8)
  histograms.update(histograms8)

  last_layer9,features9,histograms9=layer_pyramid(tf=tf, x=last_layer8,training=training,base_name="layer9")
  features.update(features9)
  histograms.update(histograms9)

  last_layer10,features10,histograms10=layer_pyramid(tf=tf, x=last_layer9,training=training,base_name="layer10")
  features.update(features10)
  histograms.update(histograms10)

  last_layer11,features11,histograms11=layer_pyramid(tf=tf, x=last_layer10,training=training,base_name="layer11")
  features.update(features11)
  histograms.update(histograms11)

  last_layer12,features12,histograms12=layer_pyramid(tf=tf, x=last_layer11,training=training,base_name="layer12")
  ...
  conv2 = deep_dive.conv2d(last_layer4, W_conv2,strides=[1, 1, 1, 1], padding='SAME') + b_conv2
