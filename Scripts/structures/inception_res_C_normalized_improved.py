...
def inception_res_C(tf, x,base_name,training=True):
  ...
  x_image=x
  W_C_conv1 = deep_dive.weight_variable_scaling([1,1,32,64], name='W_C_conv1'+base_name)
  ...
  W_C_conv2 = deep_dive.weight_variable_scaling([1,1,32,64], name='W_C_conv2'+base_name)
  ...
  W_C_conv3 = deep_dive.weight_variable_scaling([1,7,64,64], name='W_C_conv3'+base_name)
  ...
  W_C_conv4 = deep_dive.weight_variable_scaling([7,1,64,64], name='W_C_conv4'+base_name)
  ...
  W_C_conv5 = deep_dive.weight_variable_scaling([1,1,128,32], name='W_C_conv5'+base_name)
