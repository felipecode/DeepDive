...
def create_structure(tf, x, input_size,dropout):
  ...
  W_S2_incep1_7_7 = deep_dive.weight_variable_scaling([7,7,96,32], name='W_S2_incep1_7_7')
  W_S2_incep1_15_15 = deep_dive.weight_variable_scaling([15,15,96,16], name='W_S2_incep1_15_15')
  ...
  S2_incep1_3_3 = tf.nn.relu(deep_dive.conv2d(S2_conv1, W_S2_incep1_7_7, padding='SAME') + b_S2_incep1_7_7, name="S2_incep1_3_3")
  S2_incep1_5_5 = tf.nn.relu(deep_dive.conv2d(S2_conv1, W_S2_incep1_15_15, padding='SAME') + b_S2_incep1_15_15, name="S2_incep1_5_5")
  ...
  S3_incep1_1_1 = tf.nn.relu(deep_dive.conv2d(x_image, W_S3_incep1_1_1, padding='SAME') + b_S3_incep1_1_1, name="S3_incep1_1_1")
  S3_incep1_7_7 = tf.nn.relu(deep_dive.conv2d(x_image, W_S3_incep1_7_7, padding='SAME') + b_S3_incep1_7_7, name="S3_incep1_3_3")
  S3_incep1_15_15 = tf.nn.relu(deep_dive.conv2d(x_image, W_S3_incep1_15_15, padding='SAME') + b_S3_incep1_15_15, name="S3_incep1_5_5")
  ...
  """ CONCATENATE WITH PREVIOUS SCALE """

  S3_input = tf.concat(3, [S3_incep1, S2_conv2_drop])




  W_S3_incep2_1_1 = deep_dive.weight_variable_scaling([1,1,64,64], name='W_S3_incep2_1_1')
  W_S3_incep2_3_3 = deep_dive.weight_variable_scaling([3,3,64,64], name='W_S3_incep2_3_3')
  W_S3_incep2_5_5 = deep_dive.weight_variable_scaling([5,5,64,32], name='W_S3_incep2_5_5')
  ...
  S3_incep2_1_1 = tf.nn.relu(deep_dive.conv2d(S3_input, W_S3_incep2_1_1, padding='SAME') + b_S3_incep2_1_1, name="S3_incep2_1_1")
  S3_incep2_3_3 = tf.nn.relu(deep_dive.conv2d(S3_input, W_S3_incep2_3_3, padding='SAME') + b_S3_incep2_3_3, name="S3_incep2_3_3")
  S3_incep2_5_5 = tf.nn.relu(deep_dive.conv2d(S3_input, W_S3_incep2_5_5, padding='SAME') + b_S3_incep2_5_5, name="S3_incep2_5_5")
  ...
  S3_conv1 = tf.nn.relu(deep_dive.conv2d(S3_incep2_drop, W_S3_conv2,strides=[1, 1, 1, 1], padding='SAME') + b_S3_conv2, name="Scale3_second_relu")
