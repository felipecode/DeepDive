...
dataset = input_data_dive.read_data_sets(label_size=(output_size[0], output_size[1]))
...
h_conv3 = create_structure(tf, x, y_)
...
summary_writer = tf.train.SummaryWriter('/tmp/deep_dive_3',
