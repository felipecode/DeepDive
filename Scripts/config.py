...
class configMain:
	def __init__(self):
		...
		self.leveldb_path = '../datasets/datasetDepthV5/'
		self.training_path = '../datasets/datasetDepthV5/Training/'
		...
		self.training_path_ground_truth = '../datasets/datasetDepthV5/GroundTruth/'
		self.validation_path = '../datasets/datasetDepthV5/Validation/'
		self.validation_path_ground_truth = '../datasets/datasetDepthV5/ValidationGroundTruth/'
		self.summary_path = '../datasets/datasetDepthV5/summary_06_03_inception_res_BAC_normalized_mse/'
		self.models_path = '../datasets/datasetDepthV5/model_06_03_inception_res_BAC_normalized_mse/'
...
class configMainSimulator:
	def __init__(self):
		...
		self.training_path = '/media/nautec/fcc48c1a-c797-4ba9-92c0-b93b9fc4dd0e/Places/traning'
		...
		self.validation_path = '/media/nautec/fcc48c1a-c797-4ba9-92c0-b93b9fc4dd0e/Places/validation'
		self.validation_path_ground_truth = '../datasets/datasetDepthV6/ValidationGroundTruth/'
		self.summary_path = '/media/nautec/fcc48c1a-c797-4ba9-92c0-b93b9fc4dd0e/summary_06_03_inception_res_BACBAC_normalized_feature_outdoor/'
		self.models_path = '/media/nautec/fcc48c1a-c797-4ba9-92c0-b93b9fc4dd0e/model_06_03_inception_res_BACBAC_normalized_feature_outdoor/'
		self.models_discriminator_path = '/media/nautec/fcc48c1a-c797-4ba9-92c0-b93b9fc4dd0e/model_06_03_inception_res_BACBAC_normalized_feature_outdoor_discriminator/'
		self.input_size = (224, 224, 3)
		self.output_size = (224, 224, 3)
		self.depth_size = (224, 224, 1)
		self.restore = False
