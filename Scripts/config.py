...
class configMainSimulator:
	def __init__(self):
		...
		self.summary_path = '../sumario/summary_21_02_inception_res_BACBAC_normalized_feature_gan/'
		self.models_path = '../modelo/model_21_02_inception_res_BACBAC_normalized_feature_gan/'
		self.models_discriminator_path = '../modelo/model_21_02_inception_res_BACBAC_normalized_feature_discriminator/'
		self.input_size = (224, 224, 3)
		self.output_size = (224, 224, 3)
		self.depth_size = (224, 224, 1)
		self.restore = True
